...
<head>
    ...
    <title>Dashboard Siswa - R-ABSEN</title>
        ...
        <main class="p-4 md:p-8 space-y-6">
            <div class="bg-indigo-600 rounded-[2.5rem] p-8 md:p-12 text-white shadow-2xl relative overflow-hidden">
                <div class="relative z-10">
                    ...
                    <h1 class="text-3xl md:text-4xl font-black tracking-tight mb-2 uppercase italic"><?= htmlspecialchars($siswa['nama_lengkap']) ?></h1>
                </div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center justify-between group">
                            <div class="flex items-center gap-4">
                                ...
                                <span class="text-xs font-black text-slate-500 uppercase tracking-widest">NIS</span>
                            </div>
                            <span class="font-black text-slate-800 tracking-wider"><?= htmlspecialchars($siswa['nis']) ?></span>
                        </div>
                        ...
                        <div class="flex items-center justify-between group">
                            <div class="flex items-center gap-4">
                                ...
                                <span class="text-xs font-black text-slate-500 uppercase tracking-widest">Kelas</span>
                            </div>
                            <span class="font-black text-slate-800 uppercase italic"><?= htmlspecialchars($siswa['kelas_jurusan']) ?></span>
                        </div>
                    </div>
                </div>
            </div>
